...
# =============== 自定义配置 ===============
# 包含 CSV 文件的文件夹路径
DELTA_FOLDER = 'U1-U5 delta/delta'
# 保存合并后图像的文件路径
OUTPUT_IMAGE = 'U1-U5 delta/Differences in the U1-U5.png'
# 图像整体宽度和每个子图的高度
FIGURE_WIDTH = 20
SUBPLOT_HEIGHT = 7
# 横坐标时间刻度间隔（此处设置为每10年）
...
CUSTOM_XTICK_APPEND = '2032-01-01'
# 整体图标题
TITLE_MAIN = 'Differences in the U1-U5 between 1900 and 2032\n'
# =============== 结束自定义配置 ===============
