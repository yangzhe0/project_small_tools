...
# =============== 自定义配置 ===============
# 包含 CSV 文件的文件夹路径
DELTA_FOLDER = 'J1-J4 delta/delta'
# 保存合并后图像的文件路径
OUTPUT_IMAGE = 'J1-J4 delta/Differences in the J1-J4.png'
# 图像整体宽度和每个子图的高度
FIGURE_WIDTH = 20
SUBPLOT_HEIGHT = 7
# 横坐标时间刻度间隔（此处设置为每10年）
...
CUSTOM_XTICK_APPEND = '2043-01-01'
# 整体图标题
TITLE_MAIN = 'Differences in the J1-J4 between 1903 and 2043\n'
# =============== 结束自定义配置 ===============
